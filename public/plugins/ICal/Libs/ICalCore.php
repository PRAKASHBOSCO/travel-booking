...
if(!class_exists('ICalCore')) {
    class ICalCore
    {
        ...
        public function _addICalURLService($post){
            echo view('Plugin.ICal::meta.ical', $post );
        }
        ...
        public function enqueueScripts(){
            \App\Modules\Backend\Controllers\ScriptController::inst()->_addStyle('ical-css', asset('plugins/ICal/Assets/css/main.css'));
            \App\Modules\Backend\Controllers\ScriptController::inst()->_addScript('ical-js', asset('plugins/ICal/Assets/js/main.js'));
        }
