...
class TourService extends AbstractService implements ITourService {
	...
	public function __construct( ITourRepository $repository, ITourAvailabilityRepository $tourAvaiRepo, ITermRelationRepository $termRelationRepo, ITermRepository $termRepo, IOrderRepository  $orderRepo, ICommentRepository $commentRepo, ISeoRepository $seoRepo) {
