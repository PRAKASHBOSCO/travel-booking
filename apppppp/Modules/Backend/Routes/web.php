...
Route::group(
    ...
    function () {
        ...
        Route::get('edit-category/{id?}', 'CategoryController@editCategoryView')->name('edit-category');
...
Route::group([
    ...
    Route::get('sample_list', 'SampleController@sample1');
});
...
//     'prefix' => admin_config('prefix')
// ], function () {
//     // Route::get('forum_list', 'PostController@forum_list')->name('forum_list');
//     Route::get('categories_list', 'CategoryController@add_category')->name('add_category');
//     Route::get('edit_category', 'CategoryController@edit_category')->name('edit_category');
//     Route::post('create_category', 'CategoryController@create_category');
//     Route::get('store_category', 'CategoryController@store_category');
