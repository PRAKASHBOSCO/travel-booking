                    ...
                    @if(!empty($tour_types))
                        <div class="col-md-6 gmz-checkbox-wrapper">
                            ...
                            @foreach($tour_types as $key => $type)
                                <label class="checkbox-inline"><input type="checkbox" class="gmz-checkbox-item" name="tour_types[]" value="{{$key}}">{{get_translate($type)}}</label>
                            @endforeach
                    ...
                    @if(!empty($tour_include))
                        <div class="col-md-6 gmz-checkbox-wrapper">
                            ...
                            @foreach($tour_include as $key => $value)
                                <label class="checkbox-inline"><input type="checkbox" class="gmz-checkbox-item" name="tour_includes[]" value="{{$key}}">{{get_translate($value)}}</label>
                            @endforeach
                    ...
                    @if(!empty($tour_exclude))
                        <div class="col-md-6 gmz-checkbox-wrapper">
                            ...
                            @foreach($tour_exclude as $key => $value)
                                <label class="checkbox-inline"><input type="checkbox" class="gmz-checkbox-item" name="tour_excludes[]" value="{{$key}}">{{get_translate($value)}}</label>
                            @endforeach
