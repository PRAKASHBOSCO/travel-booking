                    ...
                    @if(!empty($property_types))
                        <div class="col-md-6 gmz-checkbox-wrapper mb-2">
                            ...
                            @foreach($property_types as $key => $type)
                                <label class="checkbox-inline"><input type="checkbox" class="gmz-checkbox-item" name="property_types[]" value="{{$key}}">{{get_translate($type)}}</label>
                            @endforeach
                    ...
                    @if(!empty($hotel_facilities))
                        <div class="col-md-6 gmz-checkbox-wrapper">
                            ...
                            @foreach($hotel_facilities as $key => $value)
                                <label class="checkbox-inline"><input type="checkbox" class="gmz-checkbox-item" name="hotel_facilitiess[]" value="{{$key}}">{{get_translate($value)}}</label>
                            @endforeach
                    ...
                    @if(!empty($hotel_services))
                        <div class="col-md-6 gmz-checkbox-wrapper">
                            ...
                            @foreach($hotel_services as $key => $value)
                                <label class="checkbox-inline"><input type="checkbox" class="gmz-checkbox-item" name="hotel_servicess[]" value="{{$key}}">{{get_translate($value)}}</label>
                            @endforeach
