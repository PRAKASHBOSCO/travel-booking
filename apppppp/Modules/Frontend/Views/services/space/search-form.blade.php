                    ...
                    @if(!empty($space_types))
                        <div class="col-md-6 gmz-checkbox-wrapper">
                            ...
                            @foreach($space_types as $key => $type)
                                <label class="checkbox-inline"><input type="checkbox" class="gmz-checkbox-item" name="space_types[]" value="{{$key}}">{{get_translate($type)}}</label>
                            @endforeach
                    ...
                    @if(!empty($space_amenity))
                        <div class="col-md-6 gmz-checkbox-wrapper">
                            ...
                            @foreach($space_amenity as $key => $value)
                                <label class="checkbox-inline"><input type="checkbox" class="gmz-checkbox-item" name="space_amenities[]" value="{{$key}}">{{get_translate($value)}}</label>
                            @endforeach
