                    ...
                    @if(!empty($apartment_types))
                        <div class="col-md-6 gmz-checkbox-wrapper">
                            ...
                            @foreach($apartment_types as $key => $type)
                                <label class="checkbox-inline"><input type="checkbox" class="gmz-checkbox-item" name="apartment_types[]" value="{{$key}}">{{get_translate($type)}}</label>
                            @endforeach
                    ...
                    @if(!empty($apartment_amenity))
                        <div class="col-md-6 gmz-checkbox-wrapper">
                            ...
                            @foreach($apartment_amenity as $key => $value)
                                <label class="checkbox-inline"><input type="checkbox" class="gmz-checkbox-item" name="apartment_amenities[]" value="{{$key}}">{{get_translate($value)}}</label>
                            @endforeach
