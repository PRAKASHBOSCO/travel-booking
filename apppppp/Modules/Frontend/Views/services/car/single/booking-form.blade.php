                                        ...
                                        <div class="item">
                                            <div class="name">
                                                <label class="checkbox-inline">
                                                    <input type="checkbox" name="equipment[]" value="{{$key}}">{{get_translate($term->term_title)}}
                                                </label>
                                            </div>
                                            <div class="price">
                                ...
                                <div class="card-body">
                                    @foreach($insurance as $key => $val)
                                        <div class="item">
                                            <div class="name">
                                                <label class="checkbox-inline">
                                                    <input type="checkbox" name="insurance[]" value="{{$key}}">{{get_translate($val['title'])}} <i class="fal fa-info-square desc" data-toggle="tooltip" data-placement="top" data-html="true" title="" data-original-title="{{$val['description']}} @if($val['fixed'] == 'on')<span>{{__('Fixed Price')}}</span>@endif"></i>
                                                </label>
                                            </div>
                                            <div class="price">
