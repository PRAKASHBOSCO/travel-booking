...
use App\Services\InclusionService;
...
class CustomServiceProvider extends ServiceProvider
{
   public function register()
   {
      ...
      $this->app->bind(IBeautyService::class, function () {
       ...
       $this->app->bind(ITestimonialsService::class, function () {
         return app()->make(TestimonialsService::class);
      });
         $this->app->bind(ICountriesService::class, function () {
         return app()->make(CountriesService::class);
      });
         $this->app->bind(IInclusionService::class, function () {
         return app()->make(InclusionService::class);
      });
         $this->app->bind(IPackageService::class, function () {
         return app()->make(PackageService::class);
      });
   ...
   public function provides()
   {
      return [
         ...
         ITestimonialsService::class,
         ICountriesService::class,
         IInclusionService::class,
         IPackageService::class,
