...
use App\Models\PackagesAvailability;
...
use App\Repositories\PackageAvailabilityRepository;
   ...
   public function register()
   {
      ...
      $this->app->bind(IAgentRelationRepository::class, function () {
       ...
       $this->app->bind(ISeoRepository::class, function () {
         ...
         $this->app->bind(ITestimonialsRepository::class, function () {
         return new TestimonialsRepository(new Testimonials());
      });
         $this->app->bind(ICountriesRepository::class, function () {
         return new CountriesRepository(new Countries());
      });
          $this->app->bind(IInclusionRepository::class, function () {
         return new InclusionRepository(new Inclusions());
      });
          $this->app->bind(ICountryRepository::class, function () {
         return new CountryRepository(new Country());
      });
           $this->app->bind(IStateRepository::class, function () {
         return new StateRepository(new State());
      });
           $this->app->bind(IPackageRepository::class, function () {
         return new PackageRepository(new Packages());
      });
      ...
      return [
         ...
         IWishlistRepository::class,
          ICarRepository::class,
           ...
           ITestimonialsRepository::class,
           ICountriesRepository::class,
           IInclusionRepository::class,
           ICountryRepository::class,
           IStateRepository::class,
           IPackageRepository::class,
            IPackageAvailabilityRepository::class,
