                    ...
                    @if(!empty($car_types))
                        <div class="col-md-6 gmz-checkbox-wrapper">
                            ...
                            @foreach($car_types as $key => $type)
                                <label class="checkbox-inline"><input type="checkbox" class="gmz-checkbox-item" name="car_types[]" value="{{$key}}">{{get_translate($type)}}</label>
                            @endforeach
                    ...
                    @if(!empty($car_features))
                        <div class="col-md-6 gmz-checkbox-wrapper">
                            ...
                            @foreach($car_features as $key => $value)
                                <label class="checkbox-inline"><input type="checkbox" class="gmz-checkbox-item" name="car_features[]" value="{{$key}}">{{get_translate($value)}}</label>
                            @endforeach
                    ...
                    @if(!empty($car_equipments))
                        <div class="col-md-6 gmz-checkbox-wrapper">
                            ...
                            @foreach($car_equipments as $key => $value)
                                <label class="checkbox-inline"><input type="checkbox" class="gmz-checkbox-item" name="car_equipments[]" value="{{$key}}">{{get_translate($value)}}</label>
                            @endforeach
