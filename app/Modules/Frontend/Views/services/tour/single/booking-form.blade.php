                                                            ...
                                                            <div class="item">
                                                                <div class="name">
                                                                    <label class="checkbox-inline">
                                                                        <input type="checkbox" name="extras[]" value="{{$key}}" checked onclick="return false;">{{get_translate($val['title'])}}
                                                    ...
                                                    @foreach($extras as $key => $val)
                                                        @if($val['required'] == 'off')
                                                            <div class="item">
                                                                <div class="name">
                                                                    <label class="checkbox-inline">
                                                                        <input type="checkbox" name="extras[]" value="{{$key}}">{{get_translate($val['title'])}}
                                                                    </label>
                                                                </div>
                                                                <div class="price">
                                                                    {{convert_price($val['price'])}}
