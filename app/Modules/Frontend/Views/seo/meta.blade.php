...
@if($seo_image_facebook)
<meta property="og:image" content="<?php echo get_attachment_url($seo_image_facebook) ?>"/>
@endif
...
@if($seo_image_twitter)
<meta name="twitter:image" content="<?php echo get_attachment_url($seo_image_twitter) ?>"/>
@endif
@if(isset($route))
