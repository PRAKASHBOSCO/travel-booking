...
Route::group([
    ...
    Route::get('get-states-by-country','UserController@getStates')->name('country');
...
Route::group([
    ...
    //Comment
    Route::post('add-comment', 'CommentController@addCommentAction')->name('add-comment');
...
Route::group([
   ...
   Route::get('brew_club', 'ForumController@view_categories');
