...
Route::group([
   ...
   Route::get('comment', 'PostController@allCommentView')->name('comment');
    ...
    // Categories Section By vinay
    Route::post('save-category', 'CategoryController@saveCategory');
    Route::get('all-forum-categories', 'CategoryController@view_all')->name('all-forum-categories'); 
    Route::get('new-forum-category', 'CategoryController@newCategory')->name('new-forum-category');
    Route::get('edit-category/{id?}', 'CategoryController@editCategoryView')->name('all-forum-categories');
    Route::post('delete-category', 'CategoryController@deleteCategoryAction');

   //Testimonials Section By Vinay
     Route::post('save-testimonials', 'PackagesController@saveTestimonials');
    Route::get('all-testimonials', 'PackagesController@view_all')->name('all-testimonials'); 
    Route::get('new-testimonials', 'PackagesController@newTestimonials')->name('new-testimonials');
    Route::get('edit-testimonials/{id?}', 'PackagesController@editTestimonialsView')->name('all-testimonials');
    Route::post('delete-testimonials', 'PackagesController@deleteTestimonialsAction');

    // Countries Section By Vinay
    Route::post('save-countries', 'CountriesController@saveCountries');
    Route::get('all-countries', 'CountriesController@view_all')->name('all-countries'); 
    Route::get('new-countries', 'CountriesController@newCountries')->name('new-countries');
    Route::get('edit-countries/{id?}', 'CountriesController@editCountriesView')->name('all-countries');
    Route::post('delete-countries', 'CountriesController@deleteCountriesAction');

   // Inclusion Section by vinay

    Route::post('save-inclusion', 'InclusionController@saveInclusion');
    Route::get('all-inclusion', 'InclusionController@view_all')->name('all-inclusion'); 
    Route::get('new-inclusion', 'InclusionController@newInclusion')->name('new-inclusion');
    Route::get('edit-inclusion/{id?}', 'InclusionController@editInclusionView')->name('all-inclusion');
    Route::post('delete-inclusion', 'InclusionController@deleteInclusionAction');
...
Route::group([
	...
	Route::get('all-space', 'SpaceController@allSpaceView')->name('all-space');
...
Route::group([
    ...
    'middleware' => ['web', 'auth', 'locale', 'tour_enable'],
    'prefix' => admin_config('prefix')], function () {
    Route::get('new-package', 'PackageController@newPackageView')->name('new-package');
    Route::get('all-package', 'PackageController@allPackageView')->name('all-package');
    Route::get('edit-package/{id?}', 'PackageController@editPackageView')->name('edit-package');
    Route::post('save-package', 'PackageController@savePackageAction');
    Route::post('delete-package', 'PackageController@deletePackageAction');
    Route::get('package-review', 'PackageController@allReviewView')->name('package-review');
});




Route::get('createcaptcha', 'CaptchaController@captchacreate');
...
Route::group([
    ...
    'middleware' => ['web', 'auth', 'locale', 'tour_enable'],
    'prefix' => admin_config('prefix')], function () {
    Route::get('forum', 'ForumController@fun');
});
