                ...
                <div class="row">
                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                        <div class="d-flex align-items-center justify-content-between">
                            <h4>{{__('All Packages')}}</h4>
                            <a href="{{dashboard_url('new-package')}}" class="btn btn-success">{{__('Add New')}}</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <td class="d-flex align-items-center">
                            ...
                            <div>
                                ...
                                <div class="quick-action">
                                    <a href="{{dashboard_url('edit-package/' . $item->id)}}">{{__('Edit')}}</a>
                                    <a class="text-danger gmz-link-action" href="javascript:void(0);" data-confirm="true" data-action="{{dashboard_url('delete-package')}}" data-params="{{base64_encode(json_encode($params))}}" data-remove-el="tr">{{__('Delete')}}</a>
