                ...
                <div class="col-xl-8 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="form">
                                    ...
                                    <div class="gmz-field form-group">
                                        ...
                                        <div class="media-wrapper @if(!empty($media_url)) has-media @endif">
                                            <div class="thumbnail" data-toggle="modal" data-target="#gmzMediaModal" data-url="{{dashboard_url('all-media')}}">
                                                ...
                                                @if(!empty($media_url))
                                                    <img src="{{url($media_url)}}" alt="avatar"/>
                                                @endif
                                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div id="title-field" class="field-wrapper input">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div id="last_name-field" class="field-wrapper input">
                                            ...
                                            <input id="first_name" name="first_name" type="text" value="{{$data['first_name']}}" class="form-control gmz-validation" data-validation="required" placeholder="{{__('Name')}}">
                                        </div>
                                    </div>
                                </div>
                            </div>
