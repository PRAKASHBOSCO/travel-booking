        ...
        if(isset($choices_arr[0])){
            switch ($choices_arr[0]){
                ...
                case 'term':
                    ...
                    break;
                case 'categories':
                    $choices = get_categories_recursive([], get_terms($choices_arr[1], $choices_arr[2], 'full'));
                    ...
                    break;
                     case 'testimonials':
                    $choices = get_testimonials_recursive([], get_terms($choices_arr[1], $choices_arr[2], 'full'));
