...
class AgentService extends AbstractService implements IAgentService {
	protected $repository;
	protected $termRelationRepo;

	public function __construct(IAgentRepository $repository, ITermRelationRepository $termRelationRepo) {
