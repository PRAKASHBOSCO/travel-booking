                    ...
                    <div class="comment-item-head">
                        <div class="media">
                            <div class="media-left">
                                <img alt="" src="<?php echo get_user_avatar( $v->comment_author,'small' ) ?>"
                            ...
                            <div class="media-body">
                                ...
                                <div class="date"><i class="fas fa-calendar"></i>&nbsp;<?php echo esc_html( date( 'dS M, Y', strtotime( $v->created_at ) ) ) ?></div>
                            </div>
                        </div>
                    </div>
