...
class PackageAvailabilityRepository extends AbstractRepository implements IPackageAvailabilityRepository {
    protected $model = PackagesAvailability::class;

    public function __construct(Model $model)
    {
        parent::__construct($model);
        $this->model = new PackagesAvailability();
    }
