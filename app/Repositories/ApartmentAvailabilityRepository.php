...
class ApartmentAvailabilityRepository extends AbstractRepository implements IApartmentAvailabilityRepository {
    protected $model = ApartmentAvailability::class;
